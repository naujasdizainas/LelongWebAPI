...
appHome.controller('detailCtrl', ['$scope', '$http', 'ModalService',
    function ($scope, $http, ModalService) {
        ...
        $scope.showMultiUpload = function () {
            ModalService.showModal({
                templateUrl: "imageUploadMultiple.html",
                controller: "multipleCtrl",
                inputs: {
                    title: "Upload multiple photo of goods "
                }
            }).then(function (modal) {
                modal.element.modal();
...
appHome.directive('multipleAutocomplete', ['$filter', '$http',
