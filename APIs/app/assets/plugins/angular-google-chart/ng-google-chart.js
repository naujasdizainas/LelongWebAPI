                                ...
                                if (typeof ($scope.chartWrapper) === 'undefined') {
                                    ...
                                    google.visualization.events.addListener($scope.chartWrapper, 'ready', function () {
                                        ...
                                        google.visualization.events.addListener($scope.chartWrapper.getChart(), 'onmouseover', function (e) {
                                        	if ($scope.chart.type === 'Timeline') {
                                        		if (e.row != null) {
                                        			$(".google-visualization-tooltip").html($scope.chartWrapper.getDataTable().getValue(e.row, 4))/*.css({ width: "auto",height: "auto" })*/;
                                        		}

                                        		$scope.chart.displayed = true;
                                        		$scope.$apply(function (scope) {
                                        			//scope.onmouseoverHandler({ chartWrapper: scope.chartWrapper });
                                        			//console.log('dfkdjfkd');
                                        		});
                                        	}
