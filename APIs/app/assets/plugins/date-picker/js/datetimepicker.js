			    ...
			    calendar
					.on('click.xdsoft', 'td', function (xdevent) {
					    ...
					    if (options.onSelectDate && options.onSelectDate.call) {
					        ...
					        //var hours24 = currentTime.getHours(); // retrieve current hours (in 24 mode)
					        //var dayMode = hours24 < 12 ? "AM" : "PM"; // if it's less than 12 then "am"
					        //var hours12 = hours24 <= 12 ? (hours24 == 0 ? 12 : hours24) : hours24 - 12;
					        //if (hours12<10) {
					        //    hours12 = "0" + hours12;
					        //}
					        //var timeInit = hours12 + ":00 " + dayMode;
					     
					      
					        //if ($('#StartDate').val()) {
					        //    if (!$('#StartTime').val()) {
					        //        $('#StartTime').val(timeInit);
					        //        $("#StartTime").focus();
			    ...
			    timebox
					.on('click.xdsoft', 'div', function (xdevent) {
					    ...
					    if (options.onSelectTime && $.isFunction(options.onSelectTime)) {
					        ...
					        //    if ($('#StartTime').val() === "12:01 PM") {
					        //        $('#EndTime').val("01:00 PM");
					        //        $("#EndTime").focus();
					        //    }

					        //    else if ($('#StartTime').val() === "11:01 PM") {
					        //        var newdate = moment($('#StartDate').val()).add(1, 'days').format('MM/DD/YYYY');
					        //        $('#EndDate').val(newdate);
					        ...
					        //        var hourStart = $('#StartTime').val().split(':')[0];
					        //        var hourEnd = $('#EndTime').val().split(':')[0];
					        //        if (parseInt(hourStart) > parseInt(hourEnd)) {
					        //            var str;

					        //            if (parseInt(hourStart) + 1 >= 10) {
					        //                str = $('#EndTime').val().replace(hourEnd, parseInt(hourStart) + 1);
					        //            } else
					        //                str = $('#EndTime').val().replace(parseInt(hourEnd), parseInt(hourStart) + 1);
					        //            $('#EndTime').val(str);
					        //            $("#EndTime").focus();
					        //        }
					        //    }
					        ...
					        //}
					        //if ($('#StartTime').val()) {
					        //    var exitStartValue = $('#StartTime').val().replace(":08", ":00");
					        //    var exitValue2 = exitStartValue.replace(":01", ":00");
					        //    $('#StartTime').val(exitValue2);
					        //}

					        //if ($('#EndTime').val()) {
					        //    var exitEndValue = $('#EndTime').val().replace(":08", ":00");
					        //    var newEndValue = exitEndValue.replace(":01", ":00");
					        //    $('#EndTime').val(newEndValue);
					        //}
					    }
					    datetimepicker.data('changed', true);
					    datetimepicker.trigger('xchange.xdsoft');
